...
// values will be the populations of the states. When the program runs, the user is prompted to type the name of
// a state. The program then looks in the map, using the state name
